...
public class KafkaOutputConsumer {
    ...
    @KafkaListener(topics = "kafka-final-queue", clientIdPrefix = "json",
    ...
    @KafkaListener(topics = "kafka-final-queue", clientIdPrefix = "string",
    ...
    @KafkaListener(topics = "kafka-final-queue", clientIdPrefix = "bytearray",
